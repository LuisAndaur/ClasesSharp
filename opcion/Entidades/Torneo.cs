...
namespace Entidades
{
    public static class Torneo
    {
        ...
        {
            fixture.Add(new Fecha(1, new List<Partido> { new Partido(listaEquipos[0], listaEquipos[3]), new Partido(listaEquipos[1], listaEquipos[2]) }) );
            fixture.Add(new Fecha(2, new List<Partido> { new Partido(listaEquipos[0], listaEquipos[2]), new Partido(listaEquipos[1], listaEquipos[3]) }) );
            fixture.Add(new Fecha(3, new List<Partido> { new Partido(listaEquipos[0], listaEquipos[1]), new Partido(listaEquipos[2], listaEquipos[3]) }) );
            fixture.Add(new Fecha(4, new List<Partido> { new Partido(listaEquipos[3], listaEquipos[0]), new Partido(listaEquipos[2], listaEquipos[1]) }) );
            fixture.Add(new Fecha(5, new List<Partido> { new Partido(listaEquipos[2], listaEquipos[0]), new Partido(listaEquipos[3], listaEquipos[1]) }) );
            fixture.Add(new Fecha(6, new List<Partido> { new Partido(listaEquipos[1], listaEquipos[0]), new Partido(listaEquipos[3], listaEquipos[2]) }) );
        }
